...
<div class="bg-dark row m-0">
    ...
    <div class="col-11 bg-light p-0">
        <h3 class="card-header text-center text-white bg-info">Создать медосмотр</h3>
        @if($errors->any())
        ...
        @endif
        <form class="m-5" action="{{route('create-medInspections')}}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="pressure" name="pressure" value="{{ old('pressure') }}" placeholder="Введите давление" required autocomplete="pressure" autofocus>
            </div>
            <div class="form-group">
                <label for="pulse">Пульс</label>
                <input type="number" class="form-control" id="pulse" name="pulse" value="{{ old('pulse') }}" placeholder="Введите пульс" required autocomplete="pulse" autofocus>
            </div>
            <div class="form-group">
                <label for="intoxication">Опьянение</label>
                <select name="intoxication" class="form-control" required>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="temperature" name="temperature" value="{{ old('temperature') }}" placeholder="Введите температуру" required autocomplete="temperature" autofocus>
            </div>
            <div class="row p-5">
